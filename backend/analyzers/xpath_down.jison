...
ini: CONTI EOF {console.log("fin del archivo descendente");}
;

CONTI: tk_punto AXES CONTIp
    | tk_bar AXES CONTIp
    | tk_2bar AXES CONTIp
	| PAL AXES CONTIp
	| tk_4puntos AXES CONTIp
;

CONTIp: tk_punto AXES CONTIp
    | tk_bar AXES CONTIp
    | tk_2bar AXES CONTIp
	| PAL AXES CONTIp
	| tk_4puntos AXES CONTIp
...
CORCHET: tk_corA E tk_corC CORCHETp
;

CORCHETp: tk_corA E tk_corC CORCHETp
	| 
;
