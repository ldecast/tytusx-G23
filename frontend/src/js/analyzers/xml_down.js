...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,5],$V1=[1,8],$V2=[1,10],$V3=[1,11],$V4=[2,5,7],$V5=[10,12],$V6=[1,14],$V7=[1,23],$V8=[1,24],$V9=[2,7],$Va=[7,8,18];
...
productions_: [0,[3,2],[3,2],[4,2],[4,1],[6,9],[6,9],[6,5],[6,8],[6,2],[9,1],[9,0],[14,4],[14,3],[11,2],[11,1],[13,2],[13,1],[17,1],[17,1]],
...
case 1:
		...
		ast = { ast: $$[$0-1], errors: errors };
		errors = [];
		return ast;
	
break;
case 2:
 errors.push({ tipo: "Sintáctico", error: "Sintaxis errónea del documento XML.", origen: "XML", linea: this._$.first_line, columna: this._$.first_column+1 }); this.$ = null; 
break;
case 3:
 $$[$0].push($$[$0-1]); this.$=$$[$0]; 
break;
...
case 7:
			...
			this.$ = new Element($$[$0-3], $$[$0-2], null, null, this._$.first_line, this._$.first_column+1, null);
...
table: [{2:[1,3],3:1,4:2,6:4,7:$V0},{1:[3]},{5:[1,6]},{5:[1,7],10:$V1},{2:$V2,4:9,5:[2,4],6:4,7:$V0},{8:$V3},{1:[2,1]},{1:[2,2]},o($V4,[2,9]),{5:[2,3]},{10:$V1},o($V5,[2,11],{9:12,14:13,8:$V6}),{10:[1,15],12:[1,16]},o($V5,[2,10]),{15:[1,17]},{2:$V2,6:21,7:[1,20],8:$V7,11:18,13:19,17:22,18:$V8},{10:[1,25]},{16:[1,26]},{2:$V2,6:28,7:[1,27]},{7:[1,29]},{8:$V3,12:[1,30]},o($V9,[2,15]),{7:[2,17],8:$V7,13:31,17:22,18:$V8},o($Va,[2,18]),o($Va,[2,19]),o($V4,$V9),o($V5,[2,13],{14:32,8:$V6}),{8:$V3,12:[1,33]},o($V9,[2,14]),{12:[1,34]},{8:[1,35]},{7:[2,16]},o($V5,[2,12]),{8:[1,36]},{8:[1,37]},{10:[1,38]},{10:[1,39]},{10:[1,40]},o($V4,[2,8]),o($V4,[2,5]),o($V4,[2,6])],
defaultActions: {6:[2,1],7:[2,2],9:[2,3],31:[2,16]},
