...
<string_singleq>[']				{ yytext = attribute; this.popState(); console.log("AAAAAAa"); return 'tk_attribute_s'; }
...
ROOT: ROOT XML { if ($2!==null) { $1.push($2); $$=$1; } else { $$=null; } }
...
ATTR_P: ATTR_P tk_id tk_equal TK_ATTR {
