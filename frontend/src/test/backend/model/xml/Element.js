...
var Element = /** @class */ (function () {
    ...
    * */
    ...
    Element.prototype.set3DCode = function (parent) {
    ...
    */
    ...
    Element.prototype.setChildren = function (current_stack_index) {
        var temp = Element.getNextTemp();
    ...
    Element.prototype.setParent = function (current_stack_index, parent) {
        var temp = Element.getNextTemp();
        if (parent == null) {
