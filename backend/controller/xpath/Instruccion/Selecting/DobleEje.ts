...
function DobleEje(_instruccion: any, _ambito: Ambito, _contexto: Contexto, id?: any): Contexto {
    ...
    if (expresion.tipo === Tipos.ELEMENTOS || expresion.tipo === Tipos.ASTERISCO) {
        root = getAllSymbolFromCurrent(expresion.valor, _contexto, _ambito, predicate);
    }
    else if (expresion.tipo === Tipos.ATRIBUTOS) {
        root = getAllSymbolFromCurrent({ id: expresion.valor, tipo: "@" }, _contexto, _ambito, predicate);
        ...
        root = Axis.GetAxis(expresion.axisname, expresion.nodetest, expresion.predicate, _contexto, _ambito, true);
        return root;
    }
    else {
...
function getAllSymbolFromCurrent(_nodename: any, _contexto: Contexto, _ambito: Ambito, _condicion: any): Contexto {
